  ...
  static Future<sql.Database> dataBase() async {
    ...
    return sql.openDatabase(
      ...
      onCreate: (db, version) {
        ...
        db.execute(
            'CREATE TABLE IF NOT EXISTS retorno_entrega(id integer primary key AUTOINCREMENT NOT NULL, idEntrega integer, idImportacao integer, grupoFaturamento integer, roteiro TEXT, idUsuario integer, idOcorrencia integer, dataExecucao DATE, observacao TEXT, medidor TEXT, matricula TEXT, instalacao TEXT, codBarras TEXT, codCliente TEXT, latitude TEXT, longitude TEXT, altitude TEXT, assinatura integer, pendente integer, predio integer, versaoApp TEXT)');
